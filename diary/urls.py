...
from .views import (diary_clone, diary_comment, diary_create, diary_delete,
                    diary_list, diary_update)
...
urlpatterns = [
    ...
    path('diaries/<int:pk>/comment/', diary_comment, name='diary_comment'),
]
